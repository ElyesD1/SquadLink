                    ...
                    <div className="space-y-3">
                      <div className="space-y-2">
                        <input
                          ...
                          className={`w-full px-4 py-2 bg-white/5 border border-white/10 rounded-lg ${getTextClass(currentTheme)} placeholder:${getSecondaryTextClass(currentTheme)} focus:outline-none focus:ring-2 focus:ring-purple-500/50`}
                        />
                        <input
                          type="text"
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-center gap-2">
                        ...
                        <button
                          ...
                          title="Edit name"
                        >
                          <FiEdit className={`w-4 h-4 ${getSecondaryTextClass(currentTheme)} hover:text-purple-400`} />
                        </button>
                      </div>
